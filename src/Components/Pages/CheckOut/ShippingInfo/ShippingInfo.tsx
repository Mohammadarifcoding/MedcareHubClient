        ...
        <form onSubmit={submit} className='w-full mt-10'>
            ...
            <div className='flex md:flex-nowrap flex-wrap w-full gap-3 mt-6'>
                ...
                <div className='flex flex-col gap-2 md:w-[33%] sm:w-[50%] w-full'>
                    ...
                    <input value={address.Emergency_Mobile} onChange={(e) => { setAddress({ ...address, Emergency_Mobile: e.target.value }) }} className='p-3 border-2 border-[#E1EEFF] focus:outline-none rounded-md' type="tel" name="name" id="" />
                </div>
