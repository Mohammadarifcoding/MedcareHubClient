...
const WriteBlogModal = () => {
    ...
    return (
        <div>
            <div>
                <div className="px-4 py-5 mx-auto bg-slate-200">
                    <div className="flex gap-5">
                        ...
                        <div className="w-full">
                            <input
                                ...
                                id="u_email"
                                type="u_email"
                                placeholder="Share your blog to Everyone"
                    ...
                    <div className="flex justify-between pt-5">
                        ...
                        <button className="flex items-center gap-1 p-3 bg-blue-300 rounded" onClick={() => setOpenModal(true)}>
                            Write
                        </button>
                    </div>
                </div>
