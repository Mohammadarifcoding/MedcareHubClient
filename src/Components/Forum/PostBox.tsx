                    ...
                    <div>
                        <ul className="flex gap-2 flex-col md:flex-row w-full">
                            <button
                                ...
                                className=" py-2 border-s-violet-200 rounded-2xl  bg-white flex items-center px-4 gap-2 text-[#636979] font-medium hover:bg-[#dfe6f4]"
                            >
                                <VscFiles className="text-[#1F2937] text-lg" /> All Post
                            </button>
                            <button
                                onClick={() => handleButtonClick('userPost', userEmail)}
                                className="py-2 border-s-violet-200 rounded-2xl border hover:bg-[#dfe6f4] shadow-sm bg-white flex items-center px-4 gap-2 text-[#636979] "
                            >
