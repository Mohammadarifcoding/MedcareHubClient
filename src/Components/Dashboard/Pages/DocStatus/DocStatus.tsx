            ...
            <div className="flex lg:flex-row md:flex-col flex-col gap-4">
                <div className="overflow-x-auto border shadow-xl border-blue-300 p-4 rounded-xl">
                    <table className="table">
                        ...
                        {
                            patients.map(({ name, description, schedule }, index) => (
                ...
                <div>
                    ...
                    <div className=" mt-4 text-black border
                     border-blue-300 shadow-xl p-4 rounded-xl">
                        <form>
                            <label>Name</label><br />
                            <input type="text" className="h-10 w-full mb-2 text-sm focus:outline-none
                        text-[#0360D9] p-2 rounded-xl" name="to_name" /><br />
                            <label>Email</label> <br />
                            <input type="email" className="h-10 w-full focus:outline-none mb-2 text-sm
                        text-[#0360D9] p-2 rounded-xl " name="email_id" /><br />
                            <label>Message</label> <br />
                            <textarea name="message" className="text-[#0360D9] focus:outline-none w-full p-2" /> <br />
                            <input className="btn mt-2 bg-[#0360D9] text-sm text-white"
